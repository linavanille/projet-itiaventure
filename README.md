...
- des entités spatiales (pièces, portes, objets…)
- des entités vivantes (monstres, humains…)
...
- Lecture d’un fichier de configuration décrivant le monde du jeu
- Utilisation d’un langage fonctionnel pour structurer cette configuration
...
- Chargement du jeu via un fichier de configuration
