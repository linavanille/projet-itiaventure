 ...
 * <p>
 * Cette interface définit une méthode `executer()` qui permet d'exécuter une action ou une commande
 * spécifique sur un objet ou une entité. L'implémentation de cette interface permet aux objets de réagir
 * à des événements d'exécution ou à des commandes données par le joueur ou le système.
 * </p>
 */
