 ...
 * </p>
 */
public class LecteurDescriptionFactory implements Lecteur{
     ...
     */
    public LecteurDescriptionFactory(Reader reader) throws NomDEntiteDejaUtiliseDansLeMondeException, IOException{
        Scanner scanner= new Scanner(reader);
        scanner.next();
        ITIAventureFactory factory = new ITIAventureFactory();
